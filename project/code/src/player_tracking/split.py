...
ds = sv.DetectionDataset.from_yolo(
    ...
    data_yaml_path="/scratch/users/andyjalloh/player_tracking/Tennis_Player_Detection.yolov8/data.yaml"
)
...
val_ds.as_yolo(
    images_directory_path="/scratch/users/andyjalloh/player_tracking/Tennis_Player_Detection.yolov8/val/images",
    annotations_directory_path="/scratch/users/andyjalloh/player_tracking/Tennis_Player_Detection.yolov8/val/labels",
)

test_ds.as_yolo(
    images_directory_path="/scratch/users/andyjalloh/player_tracking/Tennis_Player_Detection.yolov8/test/images",
    annotations_directory_path="/scratch/users/andyjalloh/player_tracking/Tennis_Player_Detection.yolov8/test/labels",
)